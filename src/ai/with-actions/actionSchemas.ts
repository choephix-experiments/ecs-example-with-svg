...
const BuiltInBehaviorBlueprintSchema = z
  .object({
    type: z.string(),
  })
...
const ActionSchema = z.discriminatedUnion("type", [
  z.object({
    ...
    entityProps: StageEntityPropsSchema,
  }),
  z.object({ type: z.literal("removeEntity"), entityId: z.string() }),
  z.object({
    type: z.literal("updateEntity"),
    entityId: z.string(),
    updates: StageEntityPropsSchema.partial(),
  }),
  z.object({
    type: z.literal("addBehavior"),
    entityId: z.string(),
    behaviorProps: BuiltInBehaviorBlueprintSchema,
  }),
  z.object({
    type: z.literal("removeBehavior"),
    entityId: z.string(),
    behaviorType: z.string(),
  }),
  z.object({
    type: z.literal("updateBehavior"),
    entityId: z.string(),
    behaviorType: z.string(),
    updates: z
      .object({
  ...
  z.object({
    type: z.literal("selectEntities"),
    entityIds: z.array(z.string()),
  }),
  z.object({
    type: z.literal("deselectEntities"),
    entityIds: z.array(z.string()),
  }),
